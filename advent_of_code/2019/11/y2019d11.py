...
class Hull:
    ...
    def turn_robot(self, turn):
        if (self.robot_looks == Hull.UP and turn == Hull.TURN_LEFT) or (
            self.robot_looks == Hull.DOWN and turn == Hull.TURN_RIGHT
        ):
            self.robot_looks = Hull.LEFT
        elif (self.robot_looks == Hull.UP and turn == Hull.TURN_RIGHT) or (
            self.robot_looks == Hull.DOWN and turn == Hull.TURN_LEFT
        ):
            self.robot_looks = Hull.RIGHT
        elif (self.robot_looks == Hull.RIGHT and turn == Hull.TURN_LEFT) or (
            self.robot_looks == Hull.LEFT and turn == Hull.TURN_RIGHT
        ):
            self.robot_looks = Hull.UP
        elif (self.robot_looks == Hull.RIGHT and turn == Hull.TURN_RIGHT) or (
            self.robot_looks == Hull.LEFT and turn == Hull.TURN_LEFT
        ):
