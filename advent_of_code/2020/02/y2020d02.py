...
class Policy:
    ...
    def __str__(self):
        return "{}-{} {}".format(self.value1, self.value2, self.char)
...
class Y2020D02Solver(BaseSolver):
    ...
    def check_password_validity_2(self, password, policy):
        ...
        if (char_at_poss_1 == policy.char and char_at_poss_2 == policy.char) or (
            char_at_poss_1 != policy.char and char_at_poss_2 != policy.char
        ):
            return False
        else:
            return True
