...
class Grid:
    ...
    def is_tree_visible(self, tree):
        if (
            self.is_tree_left_visible(tree)
            or self.is_tree_right_visible(tree)
            or self.is_tree_top_visible(tree)
            or self.is_tree_bottom_visible(tree)
        ):
            return True
    ...
    def tree_score(self, tree):
        return (
            self.tree_left_score(tree)
            * self.tree_right_score(tree)
            * self.tree_top_score(tree)
            * self.tree_bottom_score(tree)
        )
